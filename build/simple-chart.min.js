  ...
  return (function(e) {
        ...
        e.exports = (function() {
          ...
          function C(e) {
            var t,
              n,
              a = {};
            for (n in e) _(e, n) && (t = F(n)) && (a[t] = e[n]);
            return a;
          }
          var W = {};
          function E(e, t) {
          ...
          function Je(e, t, n) {
            ...
            return (
              s < 1
                ? ((r = e.year() - 1), (a = s + Ue(r, t, n)))
                : s > Ue(e.year(), t, n)
                ? ((a = s - Ue(e.year(), t, n)), (r = e.year() + 1))
                : ((r = e.year()), (a = s)),
              { week: a, year: r }
            );
          }
          ...
          function et() {
            ...
            for (s.sort(e), o.sort(e), d.sort(e), l.sort(e), t = 0; t < 7; t++)
              (o[t] = ce(o[t])), (d[t] = ce(d[t])), (l[t] = ce(l[t]));
          ...
          V("H", ["HH", 2], 0, "hour"),
            ...
            me("Hmm", function(e, t, n) {
              var a = e.length - 2;
              (t[Le] = b(e.substr(0, a))), (t[ve] = b(e.substr(a)));
            }),
            me("Hmmss", function(e, t, n) {
              var a = e.length - 4,
                r = e.length - 2;
              ...
              n &&
                ...
                ((t =
                  n[Me] < 0 || n[Me] > 11
                    ...
                    ? be
                    : -1),
                m(e)._overflowDayOfYear && (t < ye || t > ge) && (t = ge),
                m(e)._overflowWeeks && -1 === t && (t = ke),
                m(e)._overflowWeekday && -1 === t && (t = De),
                (m(e).overflow = t)),
              e
            );
          }
          ...
          function bt(e) {
            ...
            if (d) {
              for (m(e).iso = !0, t = 0, n = Lt.length; t < n; t++)
                if (Lt[t][1].exec(d[1])) {
                  (r = Lt[t][0]), (a = !1 !== Lt[t][2]);
                  break;
                }
            ...
            if (e._f !== r.ISO_8601)
              if (e._f !== r.RFC_2822) {
                ...
                var t,
                  ...
                  l = 0;
                for (
                  a = U(e._f, e._locale).match(z) || [], t = 0;
                  t < a.length;
                  t++
                )
                  (i = a[t]),
          ...
          function Ct(e) {
            ...
            (this._isValid = (function(e) {
              for (var t in e)
                if (-1 === Te.call(Ft, t) || (null != e[t] && isNaN(e[t])))
                  return !1;
              for (var n = !1, a = 0; a < Ft.length; ++a)
                if (e[Ft[a]]) {
                  if (n) return !1;
          ...
          function Nt(e, t) {
            ...
            return t._isUTC
              ? ((n = t.clone()),
                (a =
                  (v(e) || l(e) ? e.valueOf() : jt(e).valueOf()) - n.valueOf()),
            ...
            return function(n, a) {
              ...
              return (
                null === a ||
                  ...
                  (n = a),
                  (a = r)),
                Zt(this, Gt((n = "string" == typeof n ? +n : n), a), e),
                this
              );
            };
          }
          ...
          for (pn = "S"; pn.length <= 9; pn += "S") me(pn, Mn);
          ...
          (Ln.add = Xt),
            (Ln.calendar = function(e, t) {
              ...
              return this.format(
                s || this.localeData().calendar(i, this, jt(n))
              );
            }),
            (Ln.clone = function() {
              return new L(this);
            ...
            (Ln.diff = function(e, t, n) {
              ...
              switch (
                ((r = 6e4 * (a.utcOffset() - this.utcOffset())), (t = F(t)))
              ) {
                case "year":
                  i = en(this, a) / 12;
                  break;
          ...
          function Dn(e, t, n, a) {
            ...
            var r,
              i = ht(),
              s = e ? i._week.dow : 0;
            if (null != n) return bn(t, (n + s) % 7, a, "day");
            var o = [];
            for (r = 0; r < 7; r++) o[r] = bn(t, (r + s) % 7, a, "day");
            return o;
          }
          (Yn.calendar = function(e, t, n) {
            ...
            (Yn.monthsRegex = function(e) {
              return this._monthsParseExact
                ? (_(this, "_monthsRegex") || Re.call(this),
          ...
          function Qn() {
            ...
            if (!_) return "P0D";
            var c = _ < 0 ? "-" : "",
              h = Xn(this._months) !== Xn(_) ? "-" : "",
              m = Xn(this._days) !== Xn(_) ? "-" : "",
          ...
          return (
            ...
            (ea.as = function(e) {
              ...
              if ("month" === (e = F(e)) || "quarter" === e || "year" === e)
                switch (
                  ((t = this._days + a / 864e5), (n = this._months + Sn(t)), e)
                ) {
                  case "month":
                    return n;
                  case "quarter":
    ...
    function(e, t, n) {
      ...
      (function(e) {
        ...
        var M = void 0 !== e && e.env && "production",
          g = (function(e) {
            function t() {
              var n, a;
              f(this, t);
              for (var r = arguments.length, i = Array(r), s = 0; s < r; s++)
                i[s] = arguments[s];
              return (
                (n = a = p(this, e.call.apply(e, [this].concat(i)))),
            ...
            return (
              ...
              (t.prototype.updateChart = function() {
                ...
                if (this.chartInstance) {
                  t &&
                    (this.chartInstance.options = d.a.helpers.configMerge(
                  ...
                  var i = c()(a, this.props.datasetKeyProvider);
              ...
              (t.prototype.renderChart = function() {
                var e = this.props,
                  ...
                  a = e.legend,
                  r = e.type,
                  i = (e.redraw, e.plugins),
                  s = this.element,
                  o = this.memoizeDataProps();
                void 0 === a || u()(t.defaultProps.legend, a) || (n.legend = a),
                  (this.chartInstance = new d.a(s, {
                    type: r,
                    data: o,
                    options: n,
                    plugins: i
      ...
      e.exports = (function(e) {
        ...
        function i(e) {
          var t = e[0],
            ...
            r = e[2],
            i = n(e)[0],
            s = (1 / 255) * Math.min(t, Math.min(a, r)),
            r = 1 - (1 / 255) * Math.max(t, Math.max(a, r));
          return [i, 100 * s, 100 * r];
        }
        function s(e) {
          var t,
            n = e[0] / 255,
        ...
        function d(e) {
          ...
          var r = 0.4124 * t + 0.3576 * n + 0.1805 * a,
            i = 0.2126 * t + 0.7152 * n + 0.0722 * a,
            s = 0.0193 * t + 0.1192 * n + 0.9505 * a;
        ...
        function h(e) {
          var t,
            ...
            o = e[3] / 100;
          return (
            (t = 1 - Math.min(1, r * (1 - o) + o)),
            (n = 1 - Math.min(1, i * (1 - o) + o)),
            (a = 1 - Math.min(1, s * (1 - o) + o)),
            [255 * t, 255 * n, 255 * a]
          );
        }
        function m(e) {
        ...
        function p(e) {
          ...
          return (
            i <= 8
              ? (r = ((n = (100 * i) / 903.3) / 100) * 7.787 + 16 / 116)
              : ((n = 100 * Math.pow((i + 16) / 116, 3)),
                (r = Math.pow(n / 100, 1 / 3))),
            (t =
              t / 95.047 <= 0.008856
                ? (t = (95.047 * (s / 500 + r - 16 / 116)) / 7.787)
                : 95.047 * Math.pow(s / 500 + r, 3)),
            (a =
              a / 108.883 <= 0.008859
                ? (a = (108.883 * (r - o / 200 - 16 / 116)) / 7.787)
                : 108.883 * Math.pow(r - o / 200, 3)),
            [t, n, a]
          );
        }
        function y(e) {
        ...
        var P = w,
          ...
          A = {
            ...
            getAlpha: function(e) {
              var t = F(e);
              return t ? t[3] : (t = C(e)) ? t[3] : (t = W(e)) ? t[3] : void 0;
            },
        ...
        function F(e) {
          if (e) {
            ...
            if (a) {
              ...
              for (var i = 0; i < t.length; i++) t[i] = parseInt(a[i + 1]);
              n = parseFloat(a[4]);
            } else if (
              (a = e.match(
                /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i
              ...
              for (var i = 0; i < t.length; i++)
                t[i] = Math.round(2.55 * parseFloat(a[i + 1]));
              n = parseFloat(a[4]);
            } else if ((a = e.match(/(\w+)/))) {
              if ("transparent" == a[1]) return [0, 0, 0, 0];
              if (!(t = O[a[1]])) return;
            }
            for (var i = 0; i < t.length; i++) t[i] = R(t[i], 0, 255);
          ...
          if (e) {
            ...
            if (t) {
              var n = parseFloat(t[4]),
                a = R(parseInt(t[1]), 0, 360),
                r = R(parseFloat(t[2]), 0, 100),
                i = R(parseFloat(t[3]), 0, 100),
                s = R(isNaN(n) ? 1 : n, 0, 1);
              return [a, r, i, s];
            }
          }
        ...
        (J.prototype = {
          ...
          (J.prototype.getValues = function(e) {
            for (var t = this.values, n = {}, a = 0; a < e.length; a++)
              n[e.charAt(a)] = t[e][a];
          ...
          (J.prototype.setValues = function(e, t) {
            ...
            if (
              ((r.alpha = Math.max(0, Math.min(1, void 0 === o ? r.alpha : o))),
              "alpha" === e)
            )
              return !1;
            for (n = 0; n < e.length; n++)
              (a = Math.max(0, Math.min(s[e][n], r[e][n]))),
                (r[e][n] = Math.round(a));
            for (var l in i) l !== e && (r[l] = P[e][l](r[e]));
            return !0;
          }),
        ...
        var U,
          ...
          q = {
            ...
            clone: function(e) {
              ...
              if (q.isObject(e)) {
                for (
                  var t = {}, n = Object.keys(e), a = n.length, r = 0;
                  r < a;
                  ++r
                )
                  t[n[r]] = q.clone(e[n[r]]);
            ...
            _mergerIf: function(e, t, n) {
              ...
              q.isObject(a) && q.isObject(r)
                ? q.mergeIf(a, r)
                : t.hasOwnProperty(e) || (t[e] = q.clone(r));
            },
            merge: function(e, t, n) {
              ...
              for (a = (n = n || {}).merger || q._merger, r = 0; r < l; ++r)
                if (((t = d[r]), q.isObject(t)))
                  for (i = Object.keys(t), o = 0, s = i.length; o < s; ++o)
                    a(i[o], e, t, n);
              return e;
            },
            mergeIf: function(e, t) {
              return q.merge(e, t, { merger: q._mergerIf });
            },
            extend: function(e) {
              for (
                var t = function(t, n) {
                ...
                e.moveTo(t, d),
                  o < l && d < u
                    ...
                    ? (e.moveTo(o, n),
                      ...
                      e.arc(o, d, s, te, X + te))
                    : d < u
                    ? (e.arc(o, d, s, -X, 0), e.arc(o, u, s, 0, X))
                    : e.arc(o, d, s, -X, X),
                  e.closePath(),
                  e.moveTo(t, n);
              } else e.rect(t, n, a, r);
                  ...
                  switch ((e.beginPath(), t)) {
                    ...
                    case "rectRounded":
                      (l = n - (u = 0.516 * n)),
                        (o = Math.cos(_ + ne) * l),
                        (d = Math.sin(_ + ne) * l),
                        e.arc(a - o, r - d, u, _ - X, _ - te),
                        e.arc(a + d, r - o, u, _ - te, _),
                        e.arc(a + o, r + d, u, _, _ + te),
                        e.arc(a - d, r + o, u, _ + te, _ + X),
                        e.closePath();
                      break;
                    case "rect":
                      if (!i) {
                        (l = Math.SQRT1_2 * n),
                          e.rect(a - l, r - l, 2 * l, 2 * l);
                        break;
                      }
                      _ += ne;
                    case "rectRot":
                    ...
                    case "dash":
                      e.moveTo(a, r),
                        e.lineTo(a + Math.cos(_) * n, r + Math.sin(_) * n);
                  }
                  e.fill(), e.stroke();
                }
              } else
        ...
        var oe = se,
              ...
              var t = oe.global,
                ...
                a = {
                  ...
                  lineHeight: $.options.toLineHeight(
                    de(e.lineHeight, t.defaultLineHeight),
                    n
                  ),
                  size: n,
          ...
          ce = ie,
          he = le;
        (ue.easing = _e), (ue.canvas = ce), (ue.options = he);
        var me = function(e) {
          ue.extend(this, e), this.initialize.apply(this, arguments);
        };
        ue.extend(me.prototype, {
          initialize: function() {
            this.hidden = !1;
          },
          pivot: function() {
            var e = this;
            return (
              e._view || (e._view = ue.clone(e._model)), (e._start = {}), e
            );
          },
        ...
        var Me = {
            ...
            requestAnimationFrame: function() {
              var e = this;
              null === e.request &&
                (e.request = ue.requestAnimFrame.call(window, function() {
            ...
            advance: function() {
              for (var e, t, n, a, r = this.animations, i = 0; i < r.length; )
                (e = r[i]),
                  ...
                  ue.callback(e.render, [t, e], t),
                  ue.callback(e.onAnimationProgress, [e], t),
                  e.currentStep >= n
                    ? (ue.callback(e.onAnimationComplete, [e], t),
                      (t.animating = !1),
                      r.splice(i, 1))
                    : ++i;
            }
        ...
        ue.extend(Ye.prototype, {
                      ...
                      Object.defineProperty(e, t, {
                        ...
                        value: function() {
                          var t = Array.prototype.slice.call(arguments),
                            r = a.apply(this, t);
                          return (
                            ue.each(e._chartjs.listeners, function(e) {
          ...
          transition: function(e) {
            for (
              var t = this.getMeta(), n = t.data || [], a = n.length, r = 0;
              r < a;
              ++r
            )
              n[r].transition(e);
          ...
          setHoverStyle: function(e) {
            ...
            (e.$previousStyle = {
              ...
              (r.borderColor = ge(
                [a.hoverBorderColor, t.hoverBorderColor, i(r.borderColor)],
                void 0,
                n
              )),
              (r.borderWidth = ge(
                [a.hoverBorderWidth, t.hoverBorderWidth, r.borderWidth],
                void 0,
                n
              ));
          },
        ...
        var ke = fe.extend({
            ...
            inRange: function(e, t) {
              ...
              if (n) {
                for (
                  var a = ue.getAngleFromPoint(n, { x: e, y: t }),
                    r = a.angle,
                    i = a.distance,
                    s = n.startAngle,
                    o = n.endAngle;
            ...
            draw: function() {
              ...
              t.save(),
                t.beginPath(),
                t.arc(n.x, n.y, Math.max(n.outerRadius - i, 0), a, r),
                t.arc(n.x, n.y, n.innerRadius, r, a, !0),
                t.closePath(),
                ...
                n.borderWidth &&
                  ("inner" === n.borderAlign
                    ? (t.beginPath(),
                      (e = i / n.outerRadius),
                      t.arc(n.x, n.y, n.outerRadius, a - e, r + e),
                      n.innerRadius > i
                        ? ((e = i / n.innerRadius),
                          t.arc(n.x, n.y, n.innerRadius - i, r + e, a - e, !0))
                        : t.arc(n.x, n.y, i, r + Math.PI / 2, a - Math.PI / 2),
                      t.closePath(),
                      t.clip(),
                      t.beginPath(),
                      t.arc(n.x, n.y, n.outerRadius, a, r),
                      t.arc(n.x, n.y, n.innerRadius, r, a, !0),
                      t.closePath(),
        ...
        var xe = fe.extend({
            draw: function() {
              ...
              for (
                ...
                (t = o[e]),
                  (n = ue.previousItem(o, e)),
                  (a = t._view),
                  0 === e
                    ? a.skip || (i.moveTo(a.x, a.y), (u = e))
                    : ((n = -1 === u ? n : o[u]),
                      a.skip ||
                        ((u !== e - 1 && !s) || -1 === u
                          ? i.moveTo(a.x, a.y)
                          : ue.canvas.lineTo(i, n._view, t._view),
                        (u = e)));
              i.stroke(), i.restore();
            }
          }),
          Te = ue.valueOrDefault,
        ...
        var je = fe.extend({
            ...
            draw: function(e) {
              var t = this._view,
                ...
                l = d.defaultColor;
              t.skip ||
                ((void 0 === e || ue.canvas._isPointInArea(t, e)) &&
                  ...
                  ue.canvas.drawPoint(n, a, i, s, o, r)));
            }
          }),
        ...
        function Ce(e, t, n) {
          var a,
            ...
            d = (function(e) {
              ...
              return t
                ? (e.horizontal
                    ? e.base > e.x && (t = Fe(t, "left", "right"))
                    : e.base < e.y && (t = Fe(t, "bottom", "top")),
                  (n[t] = !0),
                  n)
                : n;
            })(e);
        ...
        var Ee = fe.extend({
            ...
            inRange: function(e, t) {
              return We(this._view, e, t);
            },
            inLabelRange: function(e, t) {
              var n = this._view;
              return Oe(n) ? We(n, e, null) : We(n, null, t);
            },
            inXRange: function(e) {
              return We(this._view, e, null);
            },
            inYRange: function(e) {
              return We(this._view, null, e);
            },
            getCenterPoint: function() {
              var e,
                t,
          ...
          Ne = je,
          Be = Ee;
        (Ie.Arc = ze), (Ie.Line = Re), (Ie.Point = Ne), (Ie.Rectangle = Be);
        var Ve = ue.options.resolve;
        oe._set("bar", {
          hover: { mode: "label" },
          scales: {
            xAxes: [
        ...
        var Je = be.extend({
            ...
            update: function(e) {
              var t,
                ...
                a = this.getMeta().data;
              for (
                this._ruler = this.getRuler(), t = 0, n = a.length;
                t < n;
                ++t
              )
                this.updateElement(a[t], t, e);
            },
            updateElement: function(e, t, n) {
              ...
              (e._xScale = a.getScaleForId(r.xAxisID)),
                ...
                a._updateElementGeometry(e, t, n),
                e.pivot();
            },
            _updateElementGeometry: function(e, t, n) {
              ...
              (r.horizontal = o),
                (r.base = n ? s : l.base),
                (r.x = o ? (n ? s : l.head) : u.center),
                (r.y = o ? u.center : n ? s : l.head),
                (r.height = o ? u.size : void 0),
                (r.width = o ? void 0 : u.size);
            },
            _getStacks: function(e) {
              var t,
                ...
                o = [];
              for (t = 0; t < s; ++t)
                (n = a.getDatasetMeta(t)).bar &&
                  a.isDatasetVisible(t) &&
                  (!1 === i ||
                    (!0 === i && -1 === o.indexOf(n.stack)) ||
                    (void 0 === i &&
            ...
            getRuler: function() {
              ...
              return {
                min: ue.isNullOrUndef(n.options.barThickness)
                  ? (function(e, t) {
                      var n,
                        a,
                        r,
                      ...
                      for (r = 0, i = o.length; r < i; ++r)
                        (a = e.getPixelForTick(r)),
                          (s = r > 0 ? Math.min(s, a - n) : s),
                          (n = a);
                      return s;
                    })(n, d)
                  : -1,
            ...
            calculateBarValuePixels: function(e, t) {
              var n,
                ...
                m = u.options.minBarLength,
                f = u.options.stacked,
                p = l.stack,
                y = 0;
              if (f || (void 0 === f && void 0 !== p))
                for (n = 0; n < e; ++n)
                  (a = d.getDatasetMeta(n)).bar &&
                    a.stack === p &&
                    a.controller._getValueScaleId() === u.id &&
                    d.isDatasetVisible(n) &&
                    ((r = +u.getRightValue(c[n].data[t])),
                    ((h < 0 && r < 0) || (h >= 0 && r > 0)) && (y += r));
              return (
                (i = u.getPixelForValue(y)),
                (s = u.getPixelForValue(y + h)),
                (o = s - i),
                void 0 !== m &&
                  Math.abs(o) < m &&
                  ((o = m),
                  (s = (h >= 0 && !_) || (h < 0 && _) ? i - m : i + m)),
                { size: o, base: i, head: s, center: s + o / 2 }
              );
            },
            calculateBarIndexPixels: function(e, t, n) {
              var a = n.scale.options,
                ...
                o = Math.min(
                  ue.valueOrDefault(a.maxBarThickness, 1 / 0),
                  r.chunk * r.ratio
                );
            ...
            draw: function() {
              var e = this.chart,
                ...
                r = n.length,
                i = 0;
              for (ue.canvas.clipArea(e.ctx, e.chartArea); i < r; ++i)
                isNaN(t.getRightValue(a.data[i])) || n[i].draw();
        ...
        var qe = be.extend({
            ...
            setHoverStyle: function(e) {
              ...
              (e.$previousStyle = {
                ...
                (t.backgroundColor = Ue(
                  n.hoverBackgroundColor,
                  a(n.backgroundColor)
                )),
                (t.borderColor = Ue(n.hoverBorderColor, a(n.borderColor))),
                (t.borderWidth = Ue(n.hoverBorderWidth, n.borderWidth)),
            ...
            _resolveElementOptions: function(e, t) {
              ...
              for (n = 0, a = h.length; n < a; ++n)
                _[(r = h[n])] = Ge([d[r], o[r], l[r]], c, t);
              return (
                (_.radius = Ge(
                  [d.radius, u ? u.r : void 0, o.radius, l.radius],
                  c,
                  t
                )),
                _
                ...
                return t.labels.length && t.datasets.length
                  ? t.labels.map(function(n, a) {
                      var r = e.getDatasetMeta(0),
                        ...
                        u = $e(
                          [o.borderColor, i.borderColor, d.borderColor],
                          void 0,
                          a
                        ),
                        _ = $e(
                          [o.borderWidth, i.borderWidth, d.borderWidth],
                          void 0,
                          a
                        );
                      return {
                        ...
                        strokeStyle: u,
                        lineWidth: _,
                        hidden: isNaN(i.data[a]) || r.data[a].hidden,
                        index: a
                      };
                    })
                  : [];
        ...
        var Ze = be.extend({
          ...
          update: function(e) {
            ...
            if (m < 2 * Math.PI) {
              var p = s.rotation % (2 * Math.PI),
                ...
                g = { x: Math.cos(y), y: Math.sin(y) },
                L =
                  (p <= 0 && y >= 0) || (p <= 2 * Math.PI && 2 * Math.PI <= y),
                v =
                  (p <= 0.5 * Math.PI && 0.5 * Math.PI <= y) ||
                  (p <= 2.5 * Math.PI && 2.5 * Math.PI <= y),
                Y =
                  (p <= -Math.PI && -Math.PI <= y) ||
                  (p <= Math.PI && Math.PI <= y),
                b =
                  (p <= 0.5 * -Math.PI && 0.5 * -Math.PI <= y) ||
                  (p <= 1.5 * Math.PI && 1.5 * Math.PI <= y),
                k = h / 100,
                D = {
                  x: Y
                    ? -1
                  ...
                  y: b
                    ? -1
                    : Math.min(M.y * (M.y < 0 ? 1 : k), g.y * (g.y < 0 ? 1 : k))
                },
                w = {
                  x: L
                    ? 1
                  ...
                  y: v
                    ? 1
                    : Math.max(M.y * (M.y > 0 ? 1 : k), g.y * (g.y > 0 ? 1 : k))
                },
                x = { width: 0.5 * (w.x - D.x), height: 0.5 * (w.y - D.y) };
              (l = Math.min(o / x.width, d / x.height)),
                (u = { x: -0.5 * (w.x + D.x), y: -0.5 * (w.y + D.y) });
            }
            for (t = 0, n = c.length; t < n; ++t)
              c[t]._options = a._resolveElementOptions(c[t], t);
            for (
              r.borderWidth = a.getMaxBorderWidth(),
                r.outerRadius = Math.max((l - r.borderWidth) / 2, 0),
                r.innerRadius = Math.max(h ? (r.outerRadius / 100) * h : 0, 0),
                r.radiusLength =
                  (r.outerRadius - r.innerRadius) /
                  (a._getVisibleDatasetWeightTotal() || 1),
                r.offsetX = u.x * r.outerRadius,
                r.offsetY = u.y * r.outerRadius,
                _.total = a.calculateTotal(),
                a.outerRadius =
                  r.outerRadius -
                  r.radiusLength * a._getRingWeightOffset(a.index),
                a.innerRadius = Math.max(a.outerRadius - r.radiusLength * f, 0),
                t = 0,
                n = c.length;
              t < n;
              ++t
          ...
          updateElement: function(e, t, n) {
            var a = this,
              ...
              h =
                n && o.animateRotate
                  ...
                  : e.hidden
                  ? 0
                  : a.calculateCircumference(c.data[t]) *
            ...
            (n && o.animateRotate) ||
              ((y.startAngle =
                0 === t ? s.rotation : a.getMeta().data[t - 1]._model.endAngle),
          ...
          getMaxBorderWidth: function(e) {
            ...
            if (!e)
              for (t = 0, n = u.data.datasets.length; t < n; ++t)
                if (u.isDatasetVisible(t)) {
                  (a = u.getDatasetMeta(t)),
                    (e = a.data),
                    t !== this.index && (i = a.controller);
                  break;
                }
            if (!e) return 0;
            for (t = 0, n = e.length; t < n; ++t)
              (r = e[t]),
                "inner" !==
                  (s = i ? i._resolveElementOptions(r, t) : r._options)
                    .borderAlign &&
                  ((o = s.borderWidth),
        ...
        var at = be.extend({
            ...
            update: function(e) {
              ...
              for (
                l &&
                  ...
                  (i._children = s),
                  (i._model = a._resolveLineOptions(i)),
                  i.pivot()),
                  t = 0,
                  n = s.length;
                t < n;
              ...
              for (
                l && 0 !== i._model.tension && a.updateBezierControlPoints(),
                  t = 0,
                  n = s.length;
                t < n;
                ++t
            ...
            updateElement: function(e, t, n) {
              var a,
                ...
                l = i.index,
                u = d.data[t],
                _ = i.getScaleForId(s.yAxisID),
                c = i.getScaleForId(s.xAxisID),
                h = s.dataset._model,
                m = i._resolvePointOptions(e, t);
              (a = c.getPixelForValue("object" == typeof u ? u : NaN, t, l)),
                (r = n ? _.getBasePixel() : i.calculatePointY(u, t, l)),
                (e._xScale = c),
                (e._yScale = _),
                (e._options = m),
                (e._datasetIndex = l),
            ...
            _resolvePointOptions: function(e, t) {
              var n,
                ...
                c = Object.keys(_);
              for (n = 0, a = c.length; n < a; ++n)
                (r = c[n]), (l[r] = et([o[r], s[_[r]], s[r], d[r]], u, t));
              return l;
            },
            _resolveLineOptions: function(e) {
              ...
              for (t = 0, n = u.length; t < n; ++t)
                l[(a = u[t])] = et([s[a], i[a], d[a]]);
              return (
                (l.spanGaps = Qe(i.spanGaps, o.spanGaps)),
                (l.tension = Qe(i.lineTension, d.tension)),
                (l.steppedLine = et([s.steppedLine, i.steppedLine, d.stepped])),
                l
              );
            },
            calculatePointY: function(e, t, n) {
              ...
              if (d.options.stacked) {
                for (a = 0; a < n; a++)
                  if (
                    ((r = s.data.datasets[a]),
                    "line" === (i = s.getDatasetMeta(a)).type &&
                      i.yAxisID === d.id &&
                      s.isDatasetVisible(a))
                  ) {
                    var _ = Number(d.getRightValue(r.data[t]));
                    _ < 0 ? (u += _ || 0) : (l += _ || 0);
                  }
                var c = Number(d.getRightValue(e));
                return c < 0
                  ? d.getPixelForValue(u + c)
                  : d.getPixelForValue(l + c);
              }
            ...
            updateBezierControlPoints: function() {
              ...
              if (
                ...
                ue.splineCurveMonotone(d);
              else
                for (e = 0, t = d.length; e < t; ++e)
                  (n = d[e]._model),
                    (a = ue.splineCurve(
                      ue.previousItem(d, e)._model,
                      n,
                      ue.nextItem(d, e)._model,
                      s.tension
                    )),
        ...
        var it = be.extend({
          ...
          update: function(e) {
            ...
            for (t = 0, n = u.length; t < n; ++t)
              (u[t]._options = r._resolveElementOptions(u[t], t)),
          ...
          _updateRadius: function() {
            ...
            (t.outerRadius = Math.max(r / 2, 0)),
              (t.innerRadius = Math.max(
                a.cutoutPercentage
                  ? (t.outerRadius / 100) * a.cutoutPercentage
                  : 1,
                0
              )),
              (t.radiusLength =
        ...
        oe._set("pie", ue.clone(oe.doughnut)),
        ...
        var lt = be.extend({
          ...
          update: function(e) {
            ...
            for (
              ...
              a.updateElement(s[t], t, e);
            for (a.updateBezierControlPoints(), t = 0, n = s.length; t < n; ++t)
              s[t].pivot();
          },
          updateElement: function(e, t, n) {
            var a = this,
            ...
            (e._scale = s),
              ...
              (e._model = {
                ...
                borderColor: d.borderColor,
                borderWidth: d.borderWidth,
                tension: ot(r.tension, l ? l.tension : 0),
                hitRadius: d.hitRadius
              });
          },
          _resolvePointOptions: function(e, t) {
            var n,
              ...
              c = Object.keys(_);
            for (n = 0, a = c.length; n < a; ++n)
              (r = c[n]), (l[r] = dt([o[r], s[_[r]], s[r], d[r]], u, t));
            return l;
          },
          _resolveLineOptions: function(e) {
            var t,
            ...
            for (t = 0, n = l.length; t < n; ++t)
              d[(a = l[t])] = dt([s[a], i[a], o[a]]);
            return (d.tension = ot(i.lineTension, o.tension)), d;
          },
          updateBezierControlPoints: function() {
            var e,
              t,
            ...
            for (e = 0, t = s.length; e < t; ++e)
              (n = s[e]._model),
                (a = ue.splineCurve(
                  ue.previousItem(s, e, !0)._model,
                  n,
                  ue.nextItem(s, e, !0)._model,
                  n.tension
                )),
          ...
          setHoverStyle: function(e) {
            ...
            (e.$previousStyle = {
              ...
              (t.borderColor = ot(n.hoverBorderColor, a(n.borderColor))),
              (t.borderWidth = ot(n.hoverBorderWidth, n.borderWidth)),
              (t.radius = ot(n.hoverRadius, n.radius));
          }
        });
        oe._set("scatter", {
          hover: { mode: "single" },
        ...
        function ct(e, t) {
          ...
          for (a = 0, i = o.length; a < i; ++a)
            if (e.isDatasetVisible(a))
              for (
                n = e.getDatasetMeta(a), r = 0, s = n.data.length;
                r < s;
                ++r
              ) {
                var d = n.data[r];
        ...
        function pt(e, t, n) {
          ...
          n.axis = n.axis || "x";
          var r = ft(n.axis),
            i = n.intersect ? ht(e, a) : mt(e, a, !1, r),
            s = [];
          return i.length
          ...
          modes: {
            ...
            dataset: function(e, t, n) {
              ...
              var r = ft(n.axis),
                i = n.intersect ? ht(e, a) : mt(e, a, !1, r);
              return (
                i.length > 0 && (i = e.getDatasetMeta(i[0]._datasetIndex).data),
                i
              );
            },
            "x-axis": function(e, t) {
        ...
        function gt(e, t) {
          e.forEach(function(e, t) {
            ...
            e.sort(function(e, n) {
              var a = t ? n : e,
                r = t ? e : n;
              return a.weight === r.weight
                ? a._tmpIndex_ - r._tmpIndex_
                : a.weight - r.weight;
            }),
            e.forEach(function(e) {
              delete e._tmpIndex_;
            ...
            update: function(e, t, n) {
              if (e) {
                var a = e.options.layout || {},
                  r = ue.options.toPadding(a.padding),
                  i = r.left,
                  s = r.right,
                  o = r.top,
                  d = r.bottom,
                ...
                var m,
                  ...
                  Y = M,
                  b = g,
                  k = { top: o, left: i, bottom: d, right: s },
                  D = [];
                ue.each(y, function(e) {
                  var t,
                    n = e.isHorizontal();
                  n
                    ? ((t = e.update(e.fullWidth ? M : Y, g / 2)),
                      (b -= t.height))
                    : ((t = e.update(v, b)), (Y -= t.width)),
                    ...
                    return (
                      ue.each(e, function(e) {
                        if (e.getPadding) {
                          ...
                          (t = Math.max(t, i.top)),
                            (n = Math.max(n, i.left)),
                            (a = Math.max(a, i.bottom)),
                            (r = Math.max(r, i.right));
                        }
                      }),
                      { top: t, left: n, bottom: a, right: r }
                    );
                  })(y)),
                  ue.each(f, P),
                  Lt(f, k),
                  ...
                  ue.each(f, function(e) {
                    var t = ue.findNextWhere(D, function(t) {
                        return t.box === e;
                      }),
                      n = { left: 0, right: 0, top: k.top, bottom: k.bottom };
                    t && e.update(t.width, b, n);
                  }),
                  Lt(y, (k = { top: o, left: i, bottom: d, right: s }));
                var w = Math.max(m.left - k.left, 0);
                (k.left += w), (k.right += Math.max(m.right - k.right, 0));
                var x = Math.max(m.top - k.top, 0);
                (k.top += x), (k.bottom += Math.max(m.bottom - k.bottom, 0));
              ...
              function P(e) {
                ...
                if (t)
                  if (t.horizontal) {
                    var n = {
                      left: Math.max(k.left, m.left),
                      right: Math.max(k.right, m.right),
                      top: 0,
                      bottom: 0
                    };
                    e.update(e.fullWidth ? M : Y, g / 2, n);
                  } else e.update(t.width, b);
              }
              function O(e) {
                e.isHorizontal()
                  ? ((e.left = e.fullWidth ? i : k.left),
                    (e.right = e.fullWidth ? t - s : k.left + Y),
                    (e.top = j),
                    (e.bottom = j + e.height),
                    (j = e.bottom))
                  : ((e.left = H),
        ...
        function Ct(e, t, n) {
          var a,
            ...
            d = (o.resizer = (function(e) {
              ...
              return (
                Pt(n, "scroll", r.bind(n, "expand")),
                Pt(a, "scroll", r.bind(a, "shrink")),
                t
              );
            })(
              ((a = function() {
              ...
              function() {
                (s = Array.prototype.slice.call(arguments)),
                  ...
                  i ||
                    ((i = !0),
                    ue.requestAnimFrame.call(window, function() {
                      (i = !1), a.apply(r, s);
                    }));
              })
            ));
            ...
            notify: function(e, t, n) {
              ...
              for (a = 0; a < l; ++a)
                if (
                  ((r = d[a]),
                  (i = r.plugin),
                  "function" == typeof (o = i[t]) &&
                    ((s = [e].concat(n || [])).push(r.options),
                    !1 === o.apply(i, s)))
                )
                  return !1;
              return !0;
                ...
                this._plugins.concat(r.plugins || []).forEach(function(e) {
                  ...
                  if (-1 === t) {
                    var r = e.id,
                      s = i[r];
                    !1 !== s &&
                      (!0 === s && (s = ue.clone(oe.global.plugins[r])),
                      n.push(e),
                      a.push({ plugin: e, options: s || {} }));
                  }
                }),
                (t.descriptors = a),
                (t.id = this._cacheId),
          ...
          Nt = {
            ...
            getScaleDefaults: function(e) {
              return this.defaults.hasOwnProperty(e)
                ? ue.merge({}, [oe.scale, this.defaults[e]])
                : {};
            },
            updateScaleDefaults: function(e, t) {
              this.defaults.hasOwnProperty(e) &&
                (this.defaults[e] = ue.extend(this.defaults[e], t));
            },
          ...
          tooltips: {
            ...
            callbacks: {
              ...
              label: function(e, t) {
                ...
                return (
                  n && (n += ": "),
                  ue.isNullOrUndef(e.value) ? (n += e.yLabel) : (n += e.value),
                  n
                );
              },
        ...
        function Jt(e, t) {
          return (
            t && (ue.isArray(t) ? Array.prototype.push.apply(e, t) : e.push(t)),
            e
          );
        }
        function Ut(e) {
        ...
        var Kt = fe.extend({
            ...
            getTitle: function() {
              var e = this._options,
                ...
                i = [];
              return (i = Jt(i, Ut(n))), (i = Jt(i, Ut(a))), (i = Jt(i, Ut(r)));
            },
            ...
            getBody: function(e, t) {
              ...
              return (
                ue.each(e, function(e) {
                  ...
                  Jt(i.before, Ut(a.beforeLabel.call(n, e, t))),
                    Jt(i.lines, a.label.call(n, e, t)),
                    Jt(i.after, Ut(a.afterLabel.call(n, e, t))),
                    r.push(i);
                }),
                r
              );
            ...
            getFooter: function() {
              var e = this._options.callbacks,
                ...
                r = [];
              return (r = Jt(r, Ut(t))), (r = Jt(r, Ut(n))), (r = Jt(r, Ut(a)));
            },
            update: function(e) {
              var t,
                n,
                ...
                f = _._active,
                p = _._data,
                y = { xAlign: h.xAlign, yAlign: h.yAlign },
                M = { x: h.x, y: h.y },
              ...
              if (f.length) {
                ...
                var v = [],
                  Y = [];
                L = Vt[c.position].call(_, f, _._eventPosition);
                var b = [];
                ...
                c.filter &&
                  ...
                  (g = (function(e, t) {
                    ...
                    return (
                      ...
                      ue.each(t.beforeBody.concat(t.afterBody), h),
                      (c = t.displayColors ? u + 2 : 0),
                      ue.each(i, function(e) {
                        ue.each(e.before, h),
                          ue.each(e.lines, h),
                          ue.each(e.after, h);
                      }),
                  ...
                  (y = (function(e, t) {
                    ...
                    "center" === _
                      ...
                      (r = function(e) {
                        return (
                          e + t.width + o.caretSize + o.caretPadding > d.width
                        );
                      }),
                      (i = function(e) {
                      ...
                      n(o.x)
                        ? ((u = "left"),
                          r(o.x) && ((u = "center"), (_ = s(o.y))))
                        : a(o.x) &&
                          ((u = "right"),
                          i(o.x) && ((u = "center"), (_ = s(o.y))));
                    var m = e._options;
                    return {
                      xAlign: m.xAlign ? m.xAlign : u,
                      yAlign: m.yAlign ? m.yAlign : _
                    };
                  })(this, g)),
                  (M = (function(e, t, n, a) {
                    var r = e.x,
            ...
            drawTitle: function(e, t, n) {
              ...
              if (a.length) {
                ...
                for (
                  ...
                  n.fillText(a[r], e.x, e.y),
                    (e.y += s + o),
                    r + 1 === a.length && (e.y += t.titleMarginBottom - o);
              }
            },
            drawBody: function(e, t, n) {
              ...
              (n.textAlign = s),
                ...
                (e.x = qt(t, s));
              var c = function(t) {
                n.fillText(t, e.x + u, e.y), (e.y += r + i);
              };
              (n.fillStyle = t.bodyFontColor),
                ue.each(t.beforeBody, c),
                (u =
                  d && "right" !== s
                    ? "center" === s
                      ? r / 2 + 1
                      : r + 2
                    : 0),
                ue.each(o, function(i, s) {
                  (a = t.labelTextColors[s]),
                    (n.fillStyle = a),
                    ue.each(i.before, c),
                    ue.each(i.lines, function(i) {
                      d &&
                        ((n.fillStyle = t.legendColorBackground),
                        n.fillRect(_, e.y, r, r),
                        (n.lineWidth = 1),
                        (n.strokeStyle = l[s].borderColor),
                        n.strokeRect(_, e.y, r, r),
                        (n.fillStyle = l[s].backgroundColor),
                        n.fillRect(_ + 1, e.y + 1, r - 2, r - 2),
                        (n.fillStyle = a)),
                        c(i);
                    }),
                    ue.each(i.after, c);
                ...
                (u = 0),
                ue.each(t.afterBody, c),
                (e.y -= i);
            },
            drawFooter: function(e, t, n) {
              var a = t.footer;
              a.length &&
                ((e.x = qt(t, t._footerAlign)),
                ...
                ue.each(a, function(a) {
                  n.fillText(a, e.x, e.y),
            ...
            handleEvent: function(e) {
              ...
              return (
                ...
                (a = !ue.arrayEquals(t._active, t._lastActive)) &&
            ...
            merger: function(e, t, n, a) {
              if ("xAxes" === e || "yAxes" === e) {
                ...
                for (t[e] || (t[e] = []), r = 0; r < o; ++r)
                  (s = n[e][r]),
                    (i = Qt(s.type, "xAxes" === e ? "category" : "linear")),
                    r >= t[e].length && t[e].push({}),
                    !t[e][r].type || (s.type && s.type !== t[e][r].type)
                      ? ue.merge(t[e][r], [Nt.getScaleDefaults(i), s])
                      : ue.merge(t[e][r], s);
          ...
          return ue.merge({}, [].slice.call(arguments), {
            merger: function(e, t, n, a) {
              ...
              "scales" === e
                ? (t[e] = en(r, i))
                : "scale" === e
                ? (t[e] = ue.merge(r, [Nt.getScaleDefaults(i.type), i]))
                : ue._merger(e, t, n, a);
            }
          });
        }
        ...
        ue.extend(an.prototype, {
          construct: function(e, t) {
            ...
            t = (function(e) {
              ...
              return (
                ...
                (t.labels = t.labels || []),
                (e.options = tn(oe.global, oe[e.type], e.options || {})),
                e
              );
            })(t);
          ...
          initialize: function() {
            var e = this;
            return (
              Rt.notify(e, "beforeInit"),
              ue.retinaScale(e, e.options.devicePixelRatio),
              e.bindEvents(),
              e.options.responsive && e.resize(!0),
              e.ensureScalesHaveIDs(),
              e.buildOrUpdateScales(),
              e.initToolTip(),
              Rt.notify(e, "afterInit"),
              e
            );
          },
          clear: function() {
          ...
          resize: function(e) {
            var t = this,
              ...
              i = Math.max(0, Math.floor(ue.getMaximumWidth(a))),
              s = Math.max(0, Math.floor(r ? i / r : ue.getMaximumHeight(a)));
            if (
              ...
              (a.style.width = i + "px"),
              (a.style.height = s + "px"),
              ue.retinaScale(t, n.devicePixelRatio),
              !e)
            ) {
              var o = { width: i, height: s };
              Rt.notify(t, "resize", [o]),
            ...
            t.scales &&
              ...
              ue.each(a, function(t) {
                var a = t.options,
                  i = a.id,
                  s = Qt(a.type, t.dtype);
                nn(a.position) !== nn(t.dposition) &&
                  (a.position = t.dposition),
                  (r[i] = !0);
                var o = null;
                if (i in n && n[i].type === s)
                  ((o = n[i]).options = a), (o.ctx = e.ctx), (o.chart = e);
                else {
              ...
              ue.each(
                ...
                function(n, a) {
                  var r = e.getDatasetMeta(a),
                    i = n.type || e.config.type;
                  if (
                    (r.type &&
                      r.type !== i &&
                      (e.destroyDatasetMeta(a), (r = e.getDatasetMeta(a))),
                    (r.type = i),
                    r.controller)
                  )
                    ...
                    (r.controller = new s(e, a)), t.push(r.controller);
                  }
                },
                e
              ),
          ...
          update: function(e) {
            ...
            if (
              ...
              (n = (t = a).options),
              ue.each(t.scales, function(e) {
                Yt.removeBox(t, e);
              }),
              (n = tn(oe.global, oe[t.config.type], n)),
          ...
          updateLayout: function() {
            !1 !== Rt.notify(this, "beforeLayout") &&
              (Yt.update(this, this.width, this.height),
              Rt.notify(this, "afterScaleUpdate"),
              Rt.notify(this, "afterLayout"));
          },
          ...
          updateDataset: function(e) {
            var t = this.getDatasetMeta(e),
              n = { meta: t, index: e };
            !1 !== Rt.notify(this, "beforeDatasetUpdate", [n]) &&
              (t.controller.update(),
              Rt.notify(this, "afterDatasetUpdate", [n]));
          },
          render: function(e) {
            var t = this;
            (e && "object" == typeof e) ||
            ...
            if (!1 !== Rt.notify(t, "beforeRender")) {
              var i = function(e) {
                Rt.notify(t, "afterRender"),
                  ue.callback(n && n.onComplete, [e], t);
              };
              if (n && a) {
                var s = new ye({
                  numSteps: a / 16.66,
                ...
                Me.addAnimation(t, s, a, r);
              } else t.draw(), i(new ye({ numSteps: 0, chart: t }));
              return t;
            }
          },
          draw: function(e) {
            var t = this;
            t.clear(),
              ue.isNullOrUndef(e) && (e = 1),
              t.transition(e),
              t.width <= 0 ||
                t.height <= 0 ||
                (!1 !== Rt.notify(t, "beforeDraw", [e]) &&
                  (ue.each(
                    t.boxes,
                    function(e) {
                      e.draw(t.chartArea);
          ...
          drawDataset: function(e, t) {
            ...
            !1 !== Rt.notify(this, "beforeDatasetDraw", [a]) &&
              (n.controller.draw(t), Rt.notify(this, "afterDatasetDraw", [a]));
          },
          _drawTooltip: function(e) {
            var t = this.tooltip,
              n = { tooltip: t, easingValue: e };
            !1 !== Rt.notify(this, "beforeTooltipDraw", [n]) &&
              (t.draw(), Rt.notify(this, "afterTooltipDraw", [n]));
          },
          getElementAtEvent: function(e) {
            return yt.modes.single(this, e);
          },
          getElementsAtEvent: function(e) {
            return yt.modes.label(this, e, { intersect: !0 });
          },
          getElementsAtXAxis: function(e) {
            return yt.modes["x-axis"](this, e, { intersect: !0 });
          },
          ...
          getDatasetAtEvent: function(e) {
            return yt.modes.dataset(this, e, { intersect: !0 });
          },
          ...
          bindEvents: function() {
            ...
            ue.each(e.options.events, function(a) {
              ...
              e.options.responsive &&
                ...
                zt.addEventListener(e, "resize", n),
                (t.resize = n));
          },
          ...
          updateHoverStyle: function(e, t, n) {
            var a,
              r,
              i,
              s = n ? "setHoverStyle" : "removeHoverStyle";
            for (r = 0, i = e.length; r < i; ++r)
              (a = e[r]) &&
                this.getDatasetMeta(a._datasetIndex).controller[s](a);
          },
          eventHandler: function(e) {
            ...
            if (!1 !== Rt.notify(t, "beforeEvent", [e])) {
              ...
              n && (a = n._start ? n.handleEvent(e) : a | n.handleEvent(e)),
                Rt.notify(t, "afterEvent", [e]);
          ...
          handleEvent: function(e) {
            ...
            return (
              ...
              t.lastActive.length &&
                t.updateHoverStyle(t.lastActive, a.mode, !1),
              t.active.length &&
                a.mode &&
                t.updateHoverStyle(t.active, a.mode, !0),
              (r = !ue.arrayEquals(t.active, t.lastActive)),
        ...
        (an.Controller = an),
          ...
          (on.override = function(e) {
            ue.extend(on.prototype, e);
          });
        var dn = { _date: on },
          ln = {
            formatters: {
        ...
        var mn = fe.extend({
            ...
            update: function(e, t, n) {
              ...
              for (
                l.beforeUpdate(),
                  ...
                  i = l.convertTicksToLabels(o) || l.ticks,
            ...
            afterBuildTicks: function(e) {
              var t = this;
              return ue.isArray(e) && e.length
                ? ue.callback(t.options.afterBuildTicks, [t, e])
                : ((t.ticks =
                    ue.callback(t.options.afterBuildTicks, [t, t.ticks]) ||
                    t.ticks),
                  e);
            },
            ...
            calculateTickRotation: function() {
              ...
              if (a.length && e.options.display && e.isHorizontal())
                for (
                  var s,
                    o = ue.longestText(t, r.string, a, e.longestTextCache),
                    d = o,
                    l = e.getPixelForTick(1) - e.getPixelForTick(0) - 6;
                  d > l && i < n.maxRotation;

                ) {
                  var u = ue.toRadians(i);
            ...
            fit: function() {
              ...
              if (
                ((t.width = l
                  ...
                  ? c
                  : 0),
                (t.height = l ? (o && s.drawTicks ? c : 0) : e.maxHeight),
                i.display && o)
              ) {
                var h = u(i),
                  m = ue.options.toPadding(i.padding),
                  f = h.lineHeight + m.height;
                l ? (t.height += f) : (t.width += f);
              }
              if (r.display && o) {
                var p = ue.longestText(e.ctx, _.string, n, e.longestTextCache),
                  y = ue.numberOfLabelLines(n),
                  M = 0.5 * _.size,
                  g = e.options.ticks.padding;
                if (((e._maxLabelLines = y), (e.longestLabelWidth = p), l)) {
                  var L = ue.toRadians(e.labelRotation),
                    v = Math.cos(L),
                    Y = Math.sin(L),
                    b = Y * p + _.lineHeight * y + M;
                  (t.height = Math.min(e.maxHeight, t.height + b + g)),
                    (e.ctx.font = _.string);
                  var k,
                    D,
                    w = hn(e.ctx, n[0], _.string),
                    x = hn(e.ctx, n[n.length - 1], _.string),
                  ...
                  0 !== e.labelRotation
                    ? ((k = "bottom" === d ? v * w : v * M),
                      (D = "bottom" === d ? v * M : v * x))
                    : ((k = w / 2), (D = x / 2)),
                    (e.paddingLeft = Math.max(k - T, 0) + 3),
            ...
            _autoSkip: function(e) {
              var t,
                ...
                _ = [];
              for (
                l > u && (o = 1 + Math.floor(l / u)),
                  s > d && (o = Math.max(o, 1 + Math.floor(s / d))),
                  t = 0;
                t < s;
                t++
              )
                (n = e[t]), o > 1 && t % o > 0 && delete n.label, _.push(n);
              return _;
            },
            _tickSize: function() {
              var e = this,
            ...
            _isVisible: function() {
              ...
              for (e = 0, t = a.data.datasets.length; e < t; ++e)
                if (
                  ...
                  ((n = a.getDatasetMeta(e)).xAxisID === this.id ||
                    n.yAxisID === this.id)
                )
                  return !0;
              return !1;
            ...
            draw: function(e) {
              ...
              if (t._isVisible()) {
                var a,
                  ...
                  D = u.padding,
                  w = u.labelOffset,
                  x = c.drawTicks ? c.tickMarkLength : 0,
                  T = un(h.fontColor, l),
                  S = M(h),
                  H = ue.options.toPadding(h.padding),
                  j = ue.toRadians(t.labelRotation),
                  P = [],
                  O = c.drawBorder ? _n(c.lineWidth, 0, 0) : 0,
                  A = ue._alignPixel;
                if (
                  ("top" === m
                    ? ((a = A(s, t.bottom, O)),
                      ...
                      (i = a - O / 2))
                    : "bottom" === m
                    ? ((a = A(s, t.top, O)), (r = a + O / 2), (i = t.top + x))
                    : "left" === m
                    ? ((a = A(s, t.right, O)),
                      (r = t.right - x),
                      (i = a - O / 2))
                  ...
                  ue.each(g, function(a, o) {
                    if (!ue.isNullOrUndef(a.label)) {
                      var d,
                        ...
                        C,
                        W = a.label;
                      o === t.zeroLineIndex && n.offset === c.offsetGridLines
                        ? ((d = c.zeroLineWidth),
                          (l = c.zeroLineColor),
                          (u = c.zeroLineBorderDash || []),
                          (_ = c.zeroLineBorderDashOffset || 0))
                        : ((d = _n(c.lineWidth, o)),
                          (l = _n(c.color, o)),
                          (u = c.borderDash || []),
                          (_ = c.borderDashOffset || 0));
                      var E = ue.isArray(W) ? W.length : 1,
                        I = (function(e, t, n) {
                          ...
                          return (
                            n &&
                              (1 === e.getTicks().length
                                ? (a -= e.isHorizontal()
                                    ? Math.max(a - e.left, e.right - a)
                                    : Math.max(a - e.top, e.bottom - a))
                                : (a -=
                                    0 === t
                                      ? (e.getPixelForTick(1) - a) / 2
                                      : (a - e.getPixelForTick(t - 1)) / 2)),
                            a
                          );
                        })(t, o, c.offsetGridLines);
                      if (y) {
                        var z = x + D;
                        I < t.left - 1e-7 && (l = "rgba(0,0,0,0)"),
                          (h = g = v = k = A(s, I, d)),
                          (M = r),
                          (L = i),
                          (S = t.getPixelForTick(o) + w),
                          "top" === m
                            ? ((b = A(s, e.top, O) + O / 2),
                              (T = e.bottom),
                              (F = ((f ? 1 : 0.5) - E) * Y),
                              ...
                              (H = t.bottom - z))
                            : ((b = e.top),
                              (T = A(s, e.bottom, O) - O / 2),
                              (F = (f ? 0 : 0.5) * Y),
                              (C = f ? "right" : "center"),
                              (H = t.top + z));
                      } else {
                        var R = (p ? 0 : x) + D;
                        I < t.top - 1e-7 && (l = "rgba(0,0,0,0)"),
                          (h = r),
                          (g = i),
                          (M = L = b = T = A(s, I, d)),
                          (H = t.getPixelForTick(o) + w),
                          (F = ((1 - E) * Y) / 2),
                          "left" === m
                            ? ((v = A(s, e.left, O) + O / 2),
                              (k = e.right),
                  ...
                  ue.each(P, function(e) {
                    ...
                    if (
                      ...
                      o.save(),
                        ...
                        o.rotate(e.rotation),
                        (o.font = e.major ? k.string : v.string),
                        (o.fillStyle = e.major ? b : L),
                  ...
                  if (y)
                    ...
                    var I = "left" === m;
                    (F = I ? t.left + E + H.top : t.right - E - H.top),
                      (C = t.top + (t.bottom - t.top) / 2),
                      (W = I ? -0.5 * Math.PI : 0.5 * Math.PI);
                  }
                  o.save(),
                    o.translate(F, C),
                    o.rotate(W),
                ...
                if (O) {
                  var z,
                    ...
                    B,
                    V = O,
                    J = _n(c.lineWidth, g.length - 1, 0);
                  y
                    ? ((z = A(s, t.left, V) - V / 2),
                      (R = A(s, t.right, J) + J / 2),
                      (N = B = a))
                    : ((N = A(s, t.top, V) - V / 2),
                      (B = A(s, t.bottom, J) + J / 2),
                      (z = R = a)),
                    (o.lineWidth = O),
                    (o.strokeStyle = _n(c.color, 0)),
                    o.beginPath(),
                    o.moveTo(z, N),
                    o.lineTo(R, B),
                    o.stroke();
          ...
          fn = mn.extend({
            ...
            getLabelForIndex: function(e, t) {
              var n = this,
                a = n.chart;
              return a.getDatasetMeta(t).controller._getValueScaleId() === n.id
                ? n.getRightValue(a.data.datasets[t].data[e])
            ...
            getPixelForValue: function(e, t) {
              ...
              if (
                (null != e && (n = a.isHorizontal() ? e.x : e.y),
              ...
              if (a.isHorizontal()) {
                var d = a.width / i,
                  l = d * (t - a.minIndex);
                return r && (l += d / 2), a.left + l;
              }
              var u = a.height / i,
                _ = u * (t - a.minIndex);
              return r && (_ += u / 2), a.top + _;
            },
            getPixelForTick: function(e) {
            ...
            getValueForPixel: function(e) {
              ...
              return (
                (e -= r ? t.left : t.top),
                n && (e -= i / 2),
                (e <= 0 ? 0 : Math.round(e / i)) + t.minIndex
              );
            },
            getBasePixel: function() {
              return this.bottom;
        ...
        var yn = ue.noop,
          ...
          gn = mn.extend({
            getRightValue: function(e) {
              return "string" == typeof e
                ? +e
                : mn.prototype.getRightValue.call(this, e);
            },
            ...
            buildTicks: function() {
              var e = this,
                ...
                r = {
                  ...
                  stepSize: ue.valueOrDefault(n.fixedStepSize, n.stepSize)
                },
                i = (e.ticks = (function(e, t) {
                  var n,
                    ...
                    h = t.min,
                    m = t.max,
                    f = ue.niceNum((m - h) / l / d) * d;
                  if (f < 1e-14 && Mn(u) && Mn(_)) return [h, m];
                  (i = Math.ceil(m / f) - Math.floor(h / f)) > l &&
                    (f = ue.niceNum((i * f) / l / d) * d),
                    o || Mn(c)
                      ? (n = Math.pow(10, ue._decimalPlaces(f)))
                      : ((n = Math.pow(10, c)), (f = Math.ceil(f * n) / n)),
                    (a = Math.floor(h / f) * f),
                    (r = Math.ceil(m / f) * f),
                    o &&
                      (!Mn(u) && ue.almostWhole(u / f, f / 1e3) && (a = u),
                      !Mn(_) && ue.almostWhole(_ / f, f / 1e3) && (r = _)),
                    (i = (r - a) / f),
                    (i = ue.almostEquals(i, Math.round(i), f / 1e3)
                      ? Math.round(i)
                      : Math.ceil(i)),
                    (a = Math.round(a * n) / n),
                    (r = Math.round(r * n) / n),
                    s.push(Mn(u) ? a : u);
                  for (var p = 1; p < i; ++p)
                    s.push(Math.round((a + p * f) * n) / n);
                  return s.push(Mn(_) ? r : _), s;
                })(r, e));
            ...
            convertTicksToLabels: function() {
              ...
              (e.ticksAsNumbers = e.ticks.slice()),
                ...
                mn.prototype.convertTicksToLabels.call(e);
            }
          }),
          Ln = { position: "left", ticks: { callback: ln.formatters.linear } },
          vn = gn.extend({
            determineDataLimits: function() {
              var e = this,
                t = e.options,
              ...
              if (
                ...
                var d = {};
                ue.each(r, function(a, r) {
                  var i = n.getDatasetMeta(r),
                    o = [
                      i.type,
                      void 0 === t.stacked && void 0 === i.stack ? r : "",
                      i.stack
                    ].join(".");
                  void 0 === d[o] &&
                    (d[o] = { positiveValues: [], negativeValues: [] });
                  var l = d[o].positiveValues,
                    u = d[o].negativeValues;
                  n.isDatasetVisible(r) &&
                    s(i) &&
                    ue.each(a.data, function(n, a) {
                  ...
                  ue.each(d, function(t) {
                    var n = t.positiveValues.concat(t.negativeValues),
                      a = ue.min(n),
                      r = ue.max(n);
                    (e.min = null === e.min ? a : Math.min(e.min, a)),
                      (e.max = null === e.max ? r : Math.max(e.max, r));
                  });
              } else
                ue.each(r, function(t, a) {
                  var r = n.getDatasetMeta(a);
                  n.isDatasetVisible(a) &&
                    s(r) &&
                    ue.each(t.data, function(t, n) {
            ...
            _computeTickLimit: function() {
              ...
              return this.isHorizontal()
                ...
                : ((e = ue.options._parseFont(this.options.ticks)),
            ...
            getPixelForValue: function(e) {
              ...
              return t.isHorizontal()
                ? t.left + (t.width / r) * (a - n)
                : t.bottom - (t.height / r) * (a - n);
            },
            getValueForPixel: function(e) {
              var t = this,
                n = t.isHorizontal(),
        ...
        var wn = mn.extend({
                    ...
                    ue.each(t.data, function(t, n) {
                      ...
                      isNaN(a) ||
                        ...
                        (null === e.min
                          ? (e.min = a)
                          : a < e.min && (e.min = a),
                        null === e.max ? (e.max = a) : a > e.max && (e.max = a),
                        0 !== a &&
                          (null === e.minNotZero || a < e.minNotZero) &&
                          (e.minNotZero = a));
                    });
                });
              this.handleTickRangeOptions();
            ...
            handleTickRangeOptions: function() {
              ...
              (e.min = Dn(t.min, e.min)),
                ...
                e.min === e.max &&
                  (0 !== e.min && null !== e.min
                    ? ((e.min = Math.pow(10, Math.floor(ue.log10(e.min)) - 1)),
                      (e.max = Math.pow(10, Math.floor(ue.log10(e.max)) + 1)))
                    : ((e.min = 1), (e.max = 10))),
                null === e.min &&
                  (e.min = Math.pow(10, Math.floor(ue.log10(e.max)) - 1)),
                null === e.max &&
                  (e.max =
                    0 !== e.min
                      ? Math.pow(10, Math.floor(ue.log10(e.min)) + 1)
                      : 10),
                null === e.minNotZero &&
                  (e.min > 0
                    ? (e.minNotZero = e.min)
                    : e.max < 1
                    ? (e.minNotZero = Math.pow(10, Math.floor(ue.log10(e.max))))
                    : (e.minNotZero = 1));
            },
            buildTicks: function() {
              var e = this,
                ...
                r = (e.ticks = (function(e, t) {
                  var n,
                    a,
                    r = [],
                    i = bn(e.min, Math.pow(10, Math.floor(ue.log10(t.min)))),
                    s = Math.floor(ue.log10(t.max)),
                    o = Math.ceil(t.max / Math.pow(10, s));
                  0 === i
                    ? ((n = Math.floor(ue.log10(t.minNotZero))),
                      (a = Math.floor(t.minNotZero / Math.pow(10, n))),
                      r.push(i),
                      (i = a * Math.pow(10, n)))
                    : ((n = Math.floor(ue.log10(i))),
                      (a = Math.floor(i / Math.pow(10, n))));
            ...
            getPixelForValue: function(e) {
              ...
              return (
                (e = +s.getRightValue(e)),
                d
                  ? ((a = s.end), (r = s.start), (i = -1))
                  : ((a = s.start), (r = s.end), (i = 1)),
                s.isHorizontal()
                  ? ((t = s.width), (n = d ? s.right : s.left))
                  : ((t = s.height), (i *= -1), (n = d ? s.top : s.bottom)),
                e !== a &&
                  (0 === a &&
                    ((_ = bn(o.fontSize, oe.global.defaultFontSize)),
                    (t -= _),
                    (a = u)),
                  0 !== e && (_ += (t / (l(r) - l(a))) * (l(e) - l(a))),
                  (n += i * _)),
                n
              );
            },
            getValueForPixel: function(e) {
              ...
              if (
                (o
                  ...
                  : ((n = i.start), (a = i.end)),
                i.isHorizontal()
                  ? ((t = i.width), (r = o ? i.right - e : e - i.left))
                  : ((t = i.height), (r = o ? e - i.top : i.bottom - e)),
                r !== n)
              ) {
                if (0 === n) {
                ...
                (r *= d(a) - d(n)), (r /= t), (r = Math.pow(10, d(n) + r));
              }
              return r;
            }
          }),
          xn = kn;
        wn._defaults = xn;
        var Tn = ue.valueOrDefault,
          Sn = ue.valueAtIndexOrDefault,
        ...
        function On(e) {
          ...
          return t.display && e.display
            ? Tn(t.fontSize, oe.global.defaultFontSize) + 2 * t.backdropPaddingY
            : 0;
        }
        ...
        var In = gn.extend({
              ...
              e.display && e.pointLabels.display
                ? (function(e) {
                    var t,
                      n,
                      a,
                      r = ue.options._parseFont(e.options.pointLabels),
                      i = {
                        l: 0,
                        r: e.width,
                        t: 0,
                    ...
                    for (t = 0; t < u; t++) {
                      (a = e.getPointPosition(t, e.drawingArea + 5)),
                        ...
                        (l = e.pointLabels[t] || ""),
                        (n = ue.isArray(l)
                          ? { w: ue.longestText(o, o.font, l), h: l.length * d }
                          : { w: o.measureText(l).width, h: d }),
                        (e._pointLabelSizes[t] = n);
                      var _ = e.getIndexAngle(t),
                        c = ue.toDegrees(_) % 360,
                        h = An(c, a.x, n.w, 0, 180),
                        m = An(c, a.y, n.h, 90, 270);
            ...
            setReductions: function(e, t, n) {
              var a = this,
                ...
                s = -t.t / Math.cos(n.t),
                o =
                  -Math.max(t.b - (a.height - a.paddingTop), 0) / Math.cos(n.b);
              (r = En(r)),
                (i = En(i)),
                (s = En(s)),
                (o = En(o)),
                ...
                (t.angleLines.display || t.pointLabels.display) &&
                  (function(e) {
                    var t = e.ctx,
                      ...
                      r = n.gridLines,
                      i = n.pointLabels,
                      s = Tn(a.lineWidth, r.lineWidth),
                      o = Tn(a.color, r.color),
                      d = On(n);
                    t.save(),
                      (t.lineWidth = s),
                      (t.strokeStyle = o),
                      t.setLineDash &&
                        (t.setLineDash(Hn([a.borderDash, r.borderDash, []])),
                        (t.lineDashOffset = Hn([
                          a.borderDashOffset,
                          r.borderDashOffset,
                          0
                        ])));
                    var l = e.getDistanceFromCenterForValue(
                        n.ticks.reverse ? e.min : e.max
                      ),
                      u = ue.options._parseFont(i);
                    (t.font = u.string), (t.textBaseline = "middle");
                    for (var _ = Pn(e) - 1; _ >= 0; _--) {
                      if (a.display && s && o) {
                        var c = e.getPointPosition(_, l);
                        t.beginPath(),
                      ...
                      if (i.display) {
                        var h = 0 === _ ? d / 2 : 0,
                          m = e.getPointPosition(_, l + h + 5),
                          f = Sn(i.fontColor, _, oe.global.defaultFontColor);
                        t.fillStyle = f;
                        var p = e.getIndexAngle(_),
                          y = ue.toDegrees(p);
                        (t.textAlign = Fn(y)),
                          Wn(y, e._pointLabelSizes[_], m),
                          Cn(t, e.pointLabels[_] || "", m, u.lineHeight);
                      }
                    }
                    t.restore();
                  })(e),
                  ue.each(e.ticks, function(t, o) {
                    if (o > 0 || a.reverse) {
                      ...
                      if (
                        ...
                        var l = Tn(a.fontColor, oe.global.defaultFontColor);
                        if (
                          ((r.font = s.string),
                          r.save(),
                          r.translate(e.xCenter, e.yCenter),
                          r.rotate(i),
                          a.showLabelBackdrop)
                        ) {
                          var u = r.measureText(t).width;
                          (r.fillStyle = a.backdropColor),
                            r.fillRect(
                              -u / 2 - a.backdropPaddingX,
                              -d - s.size / 2 - a.backdropPaddingY,
                              u + 2 * a.backdropPaddingX,
        ...
        function Gn(e) {
          var t,
            ...
            i = [];
          for (t = 0, n = e.length; t < n; ++t)
            (a = e[t]), r[a] || ((r[a] = !0), i.push(a));
          return i;
        }
        function qn(e, t, n, a) {
          var r = (function(e, t, n) {
              for (var a, r, i, s = 0, o = e.length - 1; s >= 0 && s <= o; ) {
                if (((r = e[(a = (s + o) >> 1) - 1] || null), (i = e[a]), !r))
                  return { lo: null, hi: i };
                if (i[t] < n) s = a + 1;
                else {
        ...
        function $n(e, t) {
          ...
          return (
            ...
            ue.isFinite(s) ||
              (s = "string" == typeof i ? n.parse(s, i) : n.parse(s)),
            null !== s
              ? +s
              : (r ||
                  "function" != typeof i ||
                  ((s = i(t)), ue.isFinite(s) || (s = n.parse(s))),
                s)
          );
        }
        function Kn(e, t) {
          ...
          var n = e.options.time,
            a = $n(e, e.getRightValue(t));
          return null === a
            ? a
            : (n.round && (a = +e._adapter.startOf(a, n.round)), a);
        }
        function Zn(e) {
          for (var t = Jn.indexOf(e) + 1, n = Jn.length; t < n; ++t)
            if (Vn[Jn[t]].common) return Jn[t];
        }
        function Xn(e, t, n, a) {
          var r,
            i = e._adapter,
            ...
            d =
              ...
              (function(e, t, n, a) {
                var r,
                  ...
                  s,
                  o = Jn.length;
                for (r = Jn.indexOf(e); r < o - 1; ++r)
                  if (
                    ((i = Vn[Jn[r]]),
                    (s = i.steps ? i.steps[i.steps.length - 1] : Bn),
                    i.common && Math.ceil((n - t) / (s * i.size)) <= a)
                  )
                    return Jn[r];
                return Jn[o - 1];
              })(o.minUnit, t, n, a),
          ...
          for (
            u ||
              (u = (function(e, t, n, a) {
                ...
                for (
                  r = 0, i = u.length;
                  r < i && ((s = u[r]), !(Math.ceil(o / (l * s)) <= a));
                  ++r
                );
                return s;
              })(t, n, d, a)),
              _ &&
                ((m = +i.startOf(m, "isoWeek", _)),
                (f = +i.startOf(f, "isoWeek", _))),
              m = +i.startOf(m, _ ? "day" : d),
              (f = +i.startOf(f, _ ? "day" : d)) < n && (f = +i.add(f, 1, d)),
              r = m,
              c &&
                l &&
                !_ &&
        ...
        var Qn = mn.extend({
            ...
            update: function() {
              var e = this.options,
                t = e.time || (e.time = {}),
                n = (this._adapter = new dn._date(e.adapters.date));
              return (
                t.format &&
                  console.warn(
                    "options.time.format is deprecated and replaced by options.time.parser."
                  ),
                ue.mergeIf(t.displayFormats, n.formats()),
                mn.prototype.update.apply(this, arguments)
              );
            },
            getRightValue: function(e) {
              return (
            ...
            determineDataLimits: function() {
              var e,
                ...
                f = [],
                p = o.data.labels || [];
              for (e = 0, n = p.length; e < n; ++e) f.push(Kn(s, p[e]));
              for (e = 0, n = (o.data.datasets || []).length; e < n; ++e)
                if (o.isDatasetVisible(e))
                  if (((r = o.data.datasets[e].data), ue.isObject(r[0])))
                    for (m[e] = [], t = 0, a = r.length; t < a; ++t)
                      (i = Kn(s, r[t])), h.push(i), (m[e][t] = i);
                  else {
              ...
              f.length &&
                ...
                (_ = Kn(s, l.min) || _),
                (c = Kn(s, l.max) || c),
                (_ = _ === Bn ? +d.startOf(Date.now(), u) : _),
                (c = c === Nn ? +d.endOf(Date.now(), u) + 1 : c),
                (s.min = Math.min(_, c)),
                (s.max = Math.max(_ + 1, c)),
                (s._horizontal = s.isHorizontal()),
                (s._table = []),
                (s._timestamps = { data: h, datasets: m, labels: f });
            },
            buildTicks: function() {
              var e,
                t,
              ...
              switch (s.ticks.source) {
                ...
                case "auto":
                default:
                  d = Xn(a, r, i, a.getLabelCapacity(r));
              }
              for (
                "ticks" === s.bounds &&
                  d.length &&
                  ((r = d[0]), (i = d[d.length - 1])),
                  r = Kn(a, o.min) || r,
                  i = Kn(a, o.max) || i,
                  e = 0,
                  t = d.length;
              ...
              return (
                ...
                (a._unit =
                  ...
                  (function(e, t, n, a, r) {
                    var i,
                      s,
                      o = Jn.length;
                    for (i = o - 1; i >= Jn.indexOf(n); i--)
                      if (
                        ((s = Jn[i]),
                        Vn[s].common && e._adapter.diff(r, a, s) >= t.length)
                      )
                        return s;
                    return Jn[n ? Jn.indexOf(n) : 0];
                  })(a, l, o.minUnit, a.min, a.max)),
                (a._majorUnit = Zn(a._unit)),
                (a._table = (function(e, t, n, a) {
                  if ("linear" === a || !e.length)
                    return [{ time: t, pos: 0 }, { time: n, pos: 1 }];
                  var r,
                    i,
                    s,
                    o,
                  ...
                  return l;
                })(a._timestamps.data, r, i, s.distribution)),
                    ...
                    r.offset &&
                      ...
                      (r.time.min ||
                        ...
                        (o =
                          1 === t.length
                            ? 1 - i
                            : (qn(e, "time", t[1], "pos") - i) / 2)),
                      r.time.max ||
                        ((s = qn(e, "time", t[t.length - 1], "pos")),
                        (d =
                          1 === t.length
                            ? s
                            : (s - qn(e, "time", t[t.length - 2], "pos")) /
                              2))),
                    { start: o, end: d }
                  );
                })(a._table, l, 0, 0, s)),
                ...
                (function(e, t, n) {
                  ...
                  for (a = 0, r = t.length; a < r; ++a)
                    (i = t[a]),
                      (s = !!n && i === +e._adapter.startOf(i, n)),
                      o.push({ value: i, major: s });
                  return o;
                })(a, l, a._majorUnit)
              );
            },
            getLabelForIndex: function(e, t) {
              ...
              return (
                ue.isObject(o) && (s = n.getRightValue(o)),
                i.tooltipFormat
                  ? a.format($n(n, s), i.tooltipFormat)
                  : "string" == typeof s
                  ? s
                  : a.format($n(n, s), i.displayFormats.datetime)
              );
            },
            tickFormatFunction: function(e, t, n, a) {
              var r = this._adapter,
                ...
                m = c ? _ : i.ticks.minor,
                f = Rn(m.callback, m.userCallback);
              return f ? f(h, t, n) : h;
            },
            convertTicksToLabels: function(e) {
              var t,
                ...
                a = [];
              for (t = 0, n = e.length; t < n; ++t)
                a.push(this.tickFormatFunction(e[t].value, t, e));
              return a;
            },
            ...
            getPixelForValue: function(e, t, n) {
              ...
              if (
                (void 0 !== t &&
                  void 0 !== n &&
                  (a = this._timestamps.datasets[n][t]),
                null === a && (a = Kn(this, e)),
                null !== a)
              )
            ...
            getLabelWidth: function(e) {
              var t = this.options.ticks,
                ...
                r = Math.cos(a),
                i = Math.sin(a),
                s = Rn(t.fontSize, oe.global.defaultFontSize);
              return n * r + s * i;
            },
        ...
        function ra(e, t, n) {
          var a,
            ...
            i = r.fill;
          if (
            (void 0 === i && (i = !!r.backgroundColor), !1 === i || null === i)
          )
            return !1;
        ...
        function ia(e) {
          ...
          if (
            ...
            if (ue.isFinite(i))
              return { x: (t = a.isHorizontal()) ? i : null, y: t ? null : i };
          }
          return null;
        }
        function sa(e, t, n) {
        ...
        function oa(e) {
          var t = e.fill,
            n = "dataset";
          return !1 === t ? null : (isFinite(t) || (n = "boundary"), aa[n](e));
        }
        function da(e) {
          return e && !e.skip;
        }
        function la(e, t, n, a, r) {
          ...
          if (a && r) {
            for (e.moveTo(t[0].x, t[0].y), i = 1; i < a; ++i)
              ue.canvas.lineTo(e, t[i - 1], t[i]);
            for (e.lineTo(n[r - 1].x, n[r - 1].y), i = r - 1; i > 0; --i)
              ue.canvas.lineTo(e, n[i], n[i - 1], !0);
          }
        }
        var ua = {
            id: "filler",
            afterDatasetsUpdate: function(e, t) {
              var n,
                ...
                d = [];
              for (a = 0; a < s; ++a)
                (n = e.getDatasetMeta(a)),
                  (r = n.dataset),
                  (i = null),
                  r &&
                    r._model &&
                    r instanceof Ie.Line &&
                    (i = {
            ...
            beforeDatasetDraw: function(e, t) {
              ...
              if (n) {
                var a = e.ctx,
                  ...
                  s = r._children || [],
                  o = n.mapper,
                  d = i.backgroundColor || oe.global.defaultColor;
                o &&
                  d &&
                  s.length &&
                  (ue.canvas.clipArea(a, e.chartArea),
                  (function(e, t, n, a, r, i) {
                    var s,
                      ...
                      y = 0,
                      M = 0;
                    for (e.beginPath(), s = 0, o = h + !!i; s < o; ++s)
                      (l = t[(d = s % h)]._view),
                        (u = n(l, d, a)),
                        (_ = da(l)),
                        (c = da(u)),
                        _ && c
                          ? ((y = f.push(l)), (M = p.push(u)))
                          : y &&
                            M &&
                            (m
                              ? (_ && f.push(l), c && p.push(u))
                              : (la(e, f, p, y, M),
                                (y = M = 0),
                                (f = []),
                                (p = [])));
        ...
        oe._set("global", {
          legend: {
            ...
            onClick: function(e, t) {
              ...
              (r.hidden =
                null === r.hidden ? !a.data.datasets[n].hidden : null),
                a.update();
            },
            onHover: null,
            onLeave: null,
            labels: {
              ...
              generateLabels: function(e) {
                var t = e.data;
                return ue.isArray(t.datasets)
                  ? t.datasets.map(function(t, n) {
                      return {
                        text: t.label,
                        fillStyle: ue.isArray(t.backgroundColor)
                          ? t.backgroundColor[0]
                          : t.backgroundColor,
              ...
              if (((r.font = i.string), l)) {
                ...
                (r.textAlign = "left"),
                  ...
                  ue.each(e.legendItems, function(e, t) {
                    var a = ha(n, s),
                      i = a + s / 2 + r.measureText(e.text).width;
                    (0 === t || u[u.length - 1] + i + n.padding > d.width) &&
                      ((_ += s + n.padding),
                      (u[u.length - (t > 0 ? 0 : 1)] = n.padding)),
                      (o[t] = { left: 0, top: 0, width: i, height: s }),
                ...
                ue.each(e.legendItems, function(e, t) {
                  ...
                  t > 0 &&
                    p + y > d.height - c &&
                    ((m += f + n.padding), h.push(f), (f = 0), (p = 0)),
                    (f = Math.max(f, i)),
                    (p += y),
                    (o[t] = { left: 0, top: 0, width: i, height: s });
                }),
          ...
          draw: function() {
            ...
            if (t.display) {
              ...
              ue.each(e.legendItems, function(a, u) {
                var _ = l.measureText(a.text).width,
                  y = h + c / 2 + _,
                  M = d.x,
                  g = d.y;
                f
                  ? u > 0 &&
                    M + y + n.padding > e.left + e.minSize.width &&
                    ((g = d.y += p),
                    d.line++,
                    (M = d.x = e.left + (s - o[d.line]) / 2 + n.padding))
                  : u > 0 &&
                    g + p > e.top + e.minSize.height &&
                    ((M = d.x = M + e.columnWidths[d.line] + n.padding),
                    (g = d.y = e.top + n.padding),
                    d.line++),
                  (function(e, n, a) {
                    if (!(isNaN(h) || h <= 0)) {
                      l.save();
                      var s = ca(a.lineWidth, i.borderWidth);
                      if (
                        ((l.fillStyle = ca(a.fillStyle, r)),
                        (l.lineCap = ca(a.lineCap, i.borderCapStyle)),
                        (l.lineDashOffset = ca(
                          a.lineDashOffset,
                          i.borderDashOffset
                        )),
                        (l.lineJoin = ca(a.lineJoin, i.borderJoinStyle)),
                        (l.lineWidth = s),
                        (l.strokeStyle = ca(a.strokeStyle, r)),
                        l.setLineDash &&
                          l.setLineDash(ca(a.lineDash, i.borderDash)),
            ...
            (t = n._getLegendItemAt(e.x, e.y)),
              "click" === r
                ...
                : (a.onLeave &&
                    t !== n._hoveredItem &&
                    (n._hoveredItem &&
                      a.onLeave.call(n, e.native, n._hoveredItem),
                    (n._hoveredItem = t)),
                  a.onHover && t && a.onHover.call(n, e.native, t));
          }
        });
        function fa(e, t) {
          var n = new ma({ ctx: e.ctx, options: t, chart: e });
          Yt.configure(e, n, t), Yt.addBox(e, n), (e.legend = n);
        }
        var pa = {
            id: "legend",
            _element: ma,
            ...
            beforeUpdate: function(e) {
              var t = e.options.legend,
                n = e.legend;
              t
                ? (ue.mergeIf(t, oe.global.legend),
                  n ? (Yt.configure(e, n, t), (n.options = t)) : fa(e, t))
                : n && (Yt.removeBox(e, n), delete e.legend);
            },
        ...
        var Ma = fe.extend({
          ...
          fit: function() {
            var e = this,
              ...
              n = t.display,
              a = e.minSize,
              r = ue.isArray(t.text) ? t.text.length : 1,
              i = ue.options._parseFont(t),
              s = n ? r * i.lineHeight + 2 * t.padding : 0;
            e.isHorizontal()
              ? ((a.width = e.maxWidth), (a.height = s))
              : ((a.width = s), (a.height = e.maxHeight)),
              (e.width = a.width),
              (e.height = a.height);
          },
          afterFit: ya,
          ...
          draw: function() {
            ...
            if (n.display) {
              ...
              var m = n.text;
              if (ue.isArray(m))
                for (var f = 0, p = 0; p < m.length; ++p)
                  t.fillText(m[p], 0, f, a), (f += o);
          ...
          ba = {
            ...
            beforeUpdate: function(e) {
              var t = e.options.title,
                n = e.titleBlock;
              t
                ? (ue.mergeIf(t, oe.global.title),
                  n ? (Yt.configure(e, n, t), (n.options = t)) : ga(e, t))
                : n && (Yt.removeBox(e, n), delete e.titleBlock);
            }
          };
        for (var ka in ((La.filler = va),
        (La.legend = Ya),
        (La.title = ba),
        (rn.helpers = ue),
        (function() {
          function e(e, t, n) {
            ...
            return (
              "string" == typeof e
                ? ((a = parseInt(e, 10)),
                  -1 !== e.indexOf("%") && (a = (a / 100) * t.parentNode[n]))
                : (a = e),
              a
            );
          }
          ...
          function n(n, a, r) {
            ...
            return l || u
              ? Math.min(l ? e(o, n, r) : _, u ? e(d, s, r) : _)
              : "none";
          }
          (ue.where = function(e, t) {
            ...
            (ue.findIndex = Array.prototype.findIndex
              ? function(e, t, n) {
            ...
            (ue.EPSILON = Number.EPSILON || 1e-14),
            (ue.splineCurveMonotone = function(e) {
              var t,
                n,
                a,
                r,
              ...
              for (t = 0; t < _ - 1; ++t)
                (a = u[t]),
                  ...
                  a.model.skip ||
                    r.model.skip ||
                    (ue.almostEquals(a.deltaK, 0, this.EPSILON)
                      ? (a.mK = r.mK = 0)
                      : ((i = a.mK / a.deltaK),
                        (s = r.mK / a.deltaK),
            ...
            (ue.getRelativePosition = function(e, t) {
              ...
              return (
                (n = Math.round(
                  (((n - s.left - d) / c) * i.width) / t.currentDevicePixelRatio
                )),
                (a = Math.round(
                  (((a - s.top - l) / h) * i.height) / t.currentDevicePixelRatio
                )),
                { x: n, y: a }
              );
            }),
            ...
            (ue._calculatePadding = function(e, t, n) {
              return (t = ue.getStyle(e, t)).indexOf("%") > -1
                ? (n * parseInt(t, 10)) / 100
                : parseInt(t, 10);
            }),
            ...
            (ue.getMaximumWidth = function(e) {
              ...
              var n = t.clientWidth,
                ...
                r = ue._calculatePadding(t, "padding-right", n),
                i = n - a - r,
            ...
            (ue.getMaximumHeight = function(e) {
              ...
              var n = t.clientHeight,
                ...
                r = ue._calculatePadding(t, "padding-bottom", n),
                i = n - a - r,
            ...
            (ue.retinaScale = function(e, t) {
              ...
              if (1 !== n) {
                ...
                (a.height = r * n),
                  ...
                  a.style.height ||
                    a.style.width ||
                    ((a.style.height = r + "px"), (a.style.width = i + "px"));
              }
            }),
            ...
            (ue.longestText = function(e, t, n, a) {
              ...
              a.font !== t &&
                ((r = a.data = {}), (i = a.garbageCollect = []), (a.font = t)),
                (e.font = t);
              var s = 0;
              ue.each(n, function(t) {
                null != t && !0 !== ue.isArray(t)
                  ? (s = ue.measureText(e, r, i, s, t))
                  : ue.isArray(t) &&
                    ue.each(t, function(t) {
                      null == t ||
                        ue.isArray(t) ||
                        (s = ue.measureText(e, r, i, s, t));
                    });
              ...
              var o = i.length / 2;
              if (o > n.length) {
                for (var d = 0; d < o; d++) delete r[i[d]];
                i.splice(0, o);
              }
              return s;
            }),
            (ue.measureText = function(e, t, n, a, r) {
              var i = t[r];
              return (
                i || ((i = t[r] = e.measureText(r).width), n.push(r)),
                i > a && (a = i),
                a
              );
            }),
        ...
        (rn._adapters = dn),
        (rn.Animation = ye),
        (rn.animationService = Me),
        (rn.controllers = ut),
        (rn.DatasetController = be),
        (rn.defaults = oe),
        (rn.Element = fe),
        (rn.elements = Ie),
        (rn.Interaction = yt),
        ...
        (rn.Ticks = ln),
        (rn.Tooltip = Xt),
        rn.helpers.each(ta, function(e, t) {
          rn.scaleService.registerScaleType(t, e, e._defaults);
        }),
        La))
          La.hasOwnProperty(ka) && rn.plugins.register(La[ka]);
        rn.platform.initialize();
        var Da = rn;
        return (
          "undefined" != typeof window && (window.Chart = rn),
          (rn.Chart = rn),
          (rn.Legend = La.legend._element),
          (rn.Title = La.title._element),
          (rn.pluginService = rn.plugins),
          (rn.PluginBase = rn.Element.extend({})),
          (rn.canvasHelpers = rn.helpers.canvas),
          (rn.layoutService = rn.layouts),
          (rn.LinearScaleBase = gn),
          rn.helpers.each(
            [
              "Bar",
              "Bubble",
    ...
    function(e, t, n) {
      var a = n(206),
        ...
        s = 1,
        o = 2;
      e.exports = function(e, t, n, d, l, u) {
        var _ = n & s,
          c = e.length,
          h = t.length;
        if (c != h && !(_ && h > c)) return !1;
        var m = u.get(e);
        if (m && u.get(t)) return m == t;
        var f = -1,
          p = !0,
          y = n & o ? new a() : void 0;
        for (u.set(e, t), u.set(t, e); ++f < c; ) {
          var M = e[f],
            g = t[f];
          if (d) var L = _ ? d(g, M, f, t, e, u) : d(M, g, f, e, t, u);
          if (void 0 !== L) {
            if (L) continue;
            p = !1;
            break;
          ...
          if (y) {
            if (
              !r(t, function(e, t) {
                if (!i(y, t) && (M === e || l(M, e, n, d, u))) return y.push(t);
              })
            ) {
              p = !1;
              break;
            }
          } else if (M !== g && !l(M, g, n, d, u)) {
            p = !1;
            break;
          }
        }
    ...
    function(e, t, n) {
      ...
      (k.constructor = b), a(k, v.prototype), (k.isPureReactComponent = !0);
      var D = { current: null },
        w = { current: null },
      ...
      function S(e, t, n) {
        ...
        if (null != t)
          ...
          t))
            x.call(t, a) && !T.hasOwnProperty(a) && (r[a] = t[a]);
      ...
      var R = {
          Children: {
            map: function(e, t, n) {
              if (null == e) return e;
              var a = [];
              return I(e, a, null, t, n), a;
            },
            forEach: function(e, t, n) {
              if (null == e) return e;
              F(e, W, (t = O(null, null, t, n))), A(t);
            },
            count: function(e) {
              return F(
                e,
          ...
          cloneElement: function(e, t, n) {
            ...
            var r = void 0,
              ...
              l = e._owner;
            if (null != t) {
              void 0 !== t.ref && ((d = t.ref), (l = w.current)),
            ...
            if (1 === (r = arguments.length - 2)) s.children = n;
              ...
              u = Array(r);
              for (var _ = 0; _ < r; _++) u[_] = arguments[_ + 2];
              s.children = u;
            }
            return {
              $$typeof: i,
...
*/ var a =
      ...
      e.exports = (function() {
        ...
        : function(e, t) {
            for (
              ...
              for (var l in (n = Object(arguments[d])))
                r.call(n, l) && (o[l] = n[l]);
              if (a) {
                s = a(n);
                for (var u = 0; u < s.length; u++)
                  i.call(n, s[u]) && (o[s[u]] = n[s[u]]);
              }
            }
            return o;
          };
    ...
    function(e, t) {
      ...
      function c() {
        u &&
          d &&
          ((u = !1), d.length ? (l = d.concat(l)) : (_ = -1), l.length && h());
      }
      function h() {
        if (!u) {
          var e = o(c);
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, p, y, M) {
        ...
        if (D && !b)
          return (
            M || (M = new a()),
            g || u(e) ? r(e, t, n, p, y, M) : i(e, t, v, n, p, y, M)
          );
        if (!(n & _)) {
          var w = b && f.call(e, "__wrapped__"),
            x = k && f.call(t, "__wrapped__");
          if (w || x) {
            var T = w ? e.value() : e,
              S = x ? t.value() : t;
            return M || (M = new a()), y(T, S, n, p, M);
          }
        }
        return !!D && (M || (M = new a()), s(e, t, n, p, y, M));
      };
    },
    function(e, t) {
      e.exports = function() {
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, a, Y, k, D) {
        switch (n) {
          case v:
          ...
          case y:
            var x = a & l;
            if ((w || (w = d), e.size != t.size && !x)) return !1;
            var T = D.get(e);
            if (T) return T == t;
            (a |= u), D.set(e, t);
            var S = s(w(e), w(t), a, Y, k, D);
            return D.delete(e), S;
          case g:
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, s, o, d) {
        ...
        for (var p = l; ++c < _; ) {
          var y = e[(h = u[c])],
            M = t[h];
          if (s) var g = l ? s(M, y, h, t, e, d) : s(y, M, h, e, t, d);
          if (!(void 0 === g ? y === M || o(y, M, n, s, d) : g)) {
            f = !1;
            break;
          }
          p || (p = "constructor" == h);
    ...
    function(e, t, n) {
      var a = n(232)(Object.keys, Object);
      e.exports = a;
    },
    function(e, t) {
      e.exports = function(e, t) {
    ...
    function(e, t, n) {
      var a = n(6)(n(4), "DataView");
      e.exports = a;
    },
    function(e, t, n) {
      var a = n(6)(n(4), "Promise");
      e.exports = a;
    },
    function(e, t, n) {
      var a = n(6)(n(4), "Set");
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, o) {
        ...
        for (e = Object(e); d--; ) {
          var _ = n[d];
          if (u && _[2] ? _[1] !== e[_[0]] : !(_[0] in e)) return !1;
        }
        for (; ++d < l; ) {
          var c = (_ = n[d])[0],
            h = e[c],
          ...
          if (u && _[2]) {
            ...
            var f = new a();
            if (o) var p = o(h, m, c, e, t, f);
            if (!(void 0 === p ? r(m, h, i | s, o, f) : p)) return !1;
          }
        }
        return !0;
      };
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t) {
        return s(e) && o(t)
          ...
          : function(n) {
              var s = r(n, e);
              return void 0 === s && s === t ? i(n, e) : a(t, s, u | _);
            };
      };
    },
    function(e, t, n) {
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n) {
        ...
        if (!o) return -1;
        var d = null == n ? 0 : i(n);
        return d < 0 && (d = s(o + d, 0)), a(e, r(t, 3), d);
      };
    },
    function(e, t) {
    ...
    function(e, t, n) {
      ...
      e.exports = function(e) {
        ...
        e = e.replace(s, "");
        var n = d.test(e);
        return n || l.test(e) ? u(e.slice(2), n ? 2 : 8) : o.test(e) ? i : +e;
      };
    },
    function(e, t, n) {
      var a = n(264);
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t) {
        return function(n, r) {
          ...
          if (!a(n)) return e(n, r);
          for (
            var i = n.length, s = t ? i : -1, o = Object(n);
            (t ? s-- : ++s < i) && !1 !== r(o[s], s, o);
    ...
    function(e, t, n) {
      ...
      (o.d.global.defaultFontColor = "#283444"),
        (o.d.global.defaultFontSize = 18),
        (o.d.global.defaultFontFamily = "Lato"),
        (o.d.global.tooltips.titleFontFamily = "Lato");
      class l extends r.a.Component {
        render() {
          ...
          return (function(e, t, n, a) {
            ...
            switch (e) {
              case d.V_BAR:
                return r.a.createElement(o.a.default, {
                  data: t,
                  options: n,
                  width: i,
                  height: s
              ...
              case d.H_BAR:
                return r.a.createElement(o.b.default, {
                  data: t,
                  options: n,
                  width: i,
                  height: s
              ...
              case d.LINE:
              case d.AREA:
                return r.a.createElement(o.c.default, {
                  data: t,
                  options: n,
                  width: i,
                  height: s
            ...
            e,
            (function(e, t, n) {
              const { backgroundColor: a, borderColor: r, fill: i } = n;
              return {
                labels: e,
                datasets: [
                  { data: t, backgroundColor: a, borderColor: r, fill: i }
                ]
              };
            })(t, n, i),
            (function(e, t, n, a, r) {
              const {
                ...
                tooltipTitleFontSize: h,
                tooltipTitleFontColor: m,
                tooltipBodyFontSize: f,
                tooltipBodyFontColor: p,
                displayXAxis: y,
                displayXAxisGridlines: M,
                displayXAxisTicks: g,
                beginXAxisAtZero: L,
                displayYAxis: v,
                displayYAxisGridlines: Y,
                displayYAxisTicks: b,
                beginYAxisAtZero: k
              } = r;
              return n === d.H_BAR
                ? {
                    ...
                    title: { display: l, text: a, fontSize: u },
                    tooltips: {
                      enabled: _,
                      backgroundColor: c,
                      titleFontSize: h,
                      ...
                      callbacks: {
                        label: (e, t) =>
                          Number(e.xLabel) < 0
                            ? `-$${Math.abs(Number(e.yLabel))
                                .toFixed(0)
                                .toString()
                                .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}`
                            : `$${Math.abs(Number(e.xLabel))
                                .toFixed(0)
                                .toString()
                                .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}`
                      }
      ...
      t.default = l;
      (l.propTypes = {
        chartType: s.a.string.isRequired,
        labels: s.a.arrayOf(s.a.string).isRequired,
        data: s.a.arrayOf(s.a.number).isRequired,
        title: s.a.string,
        options: s.a.object
      }),
        (l.defaultProps = {
