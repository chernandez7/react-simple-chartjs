!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.SimpleChart = t(require("react")))
    : (e.SimpleChart = t(e.React));
})(window, function(e) {
  return (function(e) {
    var t = {};
    function n(a) {
        ...
        e.exports = (function() {
          ...
          V("Y", 0, 0, function() {
            ...
            me("YYYY", function(e, t) {
              t[Me] = 2 === e.length ? r.parseTwoDigitYear(e) : b(e);
            }),
            me("YY", function(e, t) {
              ...
              n &&
                ...
                ((t =
                  n[ye] < 0 || n[ye] > 11
                    ...
                    ? be
                    : -1),
                m(e)._overflowDayOfYear && (t < Me || t > ge) && (t = ge),
            ...
            return (
              Ct(e)
                ...
                : "object" == typeof l &&
                  ...
                  (l.M = r.months)),
              (a = new Wt(l)),
              Ct(e) && _(e, "_locale") && (a._locale = e._locale),
              a
            );
          }
          function qt(e, t) {
          ...
          for (pn = "S"; pn.length <= 9; pn += "S") me(pn, yn);
    ...
    function(e, t, n) {
      ...
      (function(e) {
        ...
        var y = void 0 !== e && e.env && "production",
          g = (function(e) {
            function t() {
              var n, a;
              f(this, t);
      ...
      e.exports = (function(e) {
        ...
        var P = w,
          ...
          A = {
            ...
            getAlpha: function(e) {
              var t = F(e);
              return t ? t[3] : (t = W(e)) ? t[3] : (t = C(e)) ? t[3] : void 0;
            },
              ...
              if (f || (void 0 === f && void 0 !== p))
                for (n = 0; n < e; ++n)
                  (a = d.getDatasetMeta(n)).bar &&
                    ...
                    ((h < 0 && r < 0) || (h >= 0 && r > 0)) && (M += r));
              return (
                (i = u.getPixelForValue(M)),
                (s = u.getPixelForValue(M + h)),
                (o = s - i),
                void 0 !== m &&
                  Math.abs(o) < m &&
                  ((o = m),
          ...
          update: function(e) {
            ...
            if (m < 2 * Math.PI) {
              var p = s.rotation % (2 * Math.PI),
                ...
                L =
                  (p <= 0 && M >= 0) || (p <= 2 * Math.PI && 2 * Math.PI <= M),
                v =
                ...
                D = {
                  ...
                  y: b
                    ? -1
                    : Math.min(y.y * (y.y < 0 ? 1 : k), g.y * (g.y < 0 ? 1 : k))
                },
                w = {
                  x: L
                    ? 1
                  ...
                  y: v
                    ? 1
                    : Math.max(y.y * (y.y > 0 ? 1 : k), g.y * (g.y > 0 ? 1 : k))
                },
              ...
              if (e) {
                ...
                ue.each(M, function(e) {
                  var t,
                    n = e.isHorizontal();
                  n
                    ? ((t = e.update(e.fullWidth ? y : Y, g / 2)),
                      (b -= t.height))
                  ...
                  Lt(M, (k = { top: o, left: i, bottom: d, right: s }));
                ...
                if (
                  ...
                  if (M)
                    ...
                    (F = I ? t.left + E + H.top : t.right - E - H.top),
                      (W = t.top + (t.bottom - t.top) / 2),
                      (C = I ? -0.5 * Math.PI : 0.5 * Math.PI);
                  }
                  o.save(),
                    o.translate(F, W),
                    o.rotate(C),
            ...
            buildTicks: function() {
              var e = this,
                ...
                i = (e.ticks = (function(e, t) {
                  ...
                  if (f < 1e-14 && yn(u) && yn(_)) return [h, m];
                  (i = Math.ceil(m / f) - Math.floor(h / f)) > l &&
                    ...
                    (r = Math.ceil(m / f) * f),
                    o &&
                      (!yn(u) && ue.almostWhole(u / f, f / 1e3) && (a = u),
                      !yn(_) && ue.almostWhole(_ / f, f / 1e3) && (r = _)),
                    (i = (r - a) / f),
                    ...
                    for (var _ = Pn(e) - 1; _ >= 0; _--) {
                      ...
                      if (i.display) {
                        ...
                        var p = e.getIndexAngle(_),
                          M = ue.toDegrees(p);
                        (t.textAlign = Fn(M)),
                          Cn(M, e._pointLabelSizes[_], m),
                          Wn(t, e.pointLabels[_] || "", m, u.lineHeight);
                      }
                    }
                    t.restore();
                  })(e),
          ...
          draw: function() {
            ...
            if (t.display) {
              ...
              ue.each(e.legendItems, function(a, u) {
                ...
                f
                  ? u > 0 &&
                    y + M + n.padding > e.left + e.minSize.width &&
                    ((g = d.y += p),
                    d.line++,
                    (y = d.x = e.left + (s - o[d.line]) / 2 + n.padding))
                  : u > 0 &&
                    g + p > e.top + e.minSize.height &&
                    ((y = d.x = y + e.columnWidths[d.line] + n.padding),
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, d, l, u) {
        ...
        for (u.set(e, t), u.set(t, e); ++f < c; ) {
          var y = e[f],
            g = t[f];
          if (d) var L = _ ? d(g, y, f, t, e, u) : d(y, g, f, e, t, u);
          if (void 0 !== L) {
            if (L) continue;
            p = !1;
            break;
          ...
          if (M) {
            if (
              !r(t, function(e, t) {
                if (!i(M, t) && (y === e || l(y, e, n, d, u))) return M.push(t);
              })
            ) {
              p = !1;
              break;
            }
          } else if (y !== g && !l(y, g, n, d, u)) {
            p = !1;
            break;
          }
        }
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, p, M, y) {
        ...
        if (D && !b)
          return (
            y || (y = new a()),
            g || u(e) ? r(e, t, n, p, M, y) : i(e, t, v, n, p, M, y)
          );
        if (!(n & _)) {
          ...
          if (w || x) {
            var T = w ? e.value() : e,
              S = x ? t.value() : t;
            return y || (y = new a()), M(T, S, n, p, y);
          }
        }
        return !!D && (y || (y = new a()), s(e, t, n, p, M, y));
      };
    },
    function(e, t) {
      e.exports = function() {
    ...
    function(e, t, n) {
      ...
      e.exports = function(e, t, n, s, o, d) {
        ...
        for (var p = l; ++c < _; ) {
          var M = e[(h = u[c])],
            y = t[h];
          if (s) var g = l ? s(y, M, h, t, e, d) : s(M, y, h, e, t, d);
          if (!(void 0 === g ? M === y || o(M, y, n, s, d) : g)) {
            f = !1;
            break;
          }
          p || (p = "constructor" == h);
    ...
    function(e, t, n) {
      var a = n(230)(Object.keys, Object);
      e.exports = a;
    },
    function(e, t) {
      e.exports = function(e, t) {
